module.exports = {
    confirmLeave : (leaveType, leaveDays, leaveDate,id) =>{
        return {
            ...
                                "text": "You have applied for the leave. To know about your leave status, type \"leave status\".",
                                    ...
                                    "actions": [
                                        {
                                            ...
                                            "data" : {
                                                "actiontype" : "applyLeaveApplicationAction"
                                            }
                                        }
                                    ]
                                }
            ...
            "body": [
                ...
                },
                {
                    ...
                    "items": [
                        {
                            "type": "TextBlock",
                            "text": "Enter Your Official Email",
                            "wrap": true,
                            "size": "Medium",
                            "weight": "Bolder"
                        }
